  ...
  return (
    <div className="bg-[#D9D9D9]">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div
          aria-hidden="true"
          className="inset-x-0 top-[calc(100%-6rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-16rem)]"
        >
          <div
            style={{
              clipPath:
            ...
            className="relative left-[calc(50%+3rem)] aspect-1155/678 w-96 -translate-x-1/2 bg-linear-to-tr from-[#D9D9D9] to-[#03A63C] opacity-30 sm:left-[calc(50%+26rem)] sm:w-[36rem]"
          />
        </div>
      </div>
    </div>
